...
class Solution2102 extends Solution
{
	public $ready = true;
	...
	public function run()
	{
		...
		//This completely identical to part 1: Except for creating a mapping array $this->mapping. key = allergene, value = ingredient
		...
		//Part 2 is EZ shit:
		ksort($this->mapping); //sort by key which is the allergene
		$result = implode(',', $this->mapping);
				...
				foreach($food->allergenes as $allergene)
				{
					...
					if($matches > 0)
					{
						...
						if($matches > $crossMatches)
						{
							...
							//Thats all we need for part 2:
							$this->mapping[$allergene] = $ingredient;
