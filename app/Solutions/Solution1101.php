...
class Solution1101 extends Solution
{
	...
	/** @return int */
	private function countAdjacentSeatsOccupied(array $map, int $rowId, int $colId)
	{
		$seatsOccupied = 0;

		$seatsOccupied += isset($map[$rowId-1][$colId-1]) && $map[$rowId-1][$colId-1] === '#' ? 1 : 0; //above-left
		$seatsOccupied += isset($map[$rowId-1][$colId]) && $map[$rowId-1][$colId] === '#' ? 1 : 0; //above
		$seatsOccupied += isset($map[$rowId-1][$colId+1]) && $map[$rowId-1][$colId+1] === '#' ? 1 : 0; //above-right

		$seatsOccupied += isset($map[$rowId][$colId-1]) && $map[$rowId][$colId-1] === '#' ? 1 : 0; //same-row-left
		$seatsOccupied += isset($map[$rowId][$colId+1]) && $map[$rowId][$colId+1] === '#' ? 1 : 0; //same-row-right

		$seatsOccupied += isset($map[$rowId+1][$colId-1]) && $map[$rowId+1][$colId-1] === '#' ? 1 : 0; //below-left
		$seatsOccupied += isset($map[$rowId+1][$colId]) && $map[$rowId+1][$colId] === '#' ? 1 : 0; //below
		$seatsOccupied += isset($map[$rowId+1][$colId+1]) && $map[$rowId+1][$colId+1] === '#' ? 1 : 0; //below-right
